...
```bash
git clone https://github.com/HilderRobles/veterinaria.git
cd veterinaria
```
...
Utilizamos hilos en paralelo (--threads=4) y restringimos el análisis exclusivamente a las capas puras de Cliente para optimizar el tiempo de respuesta y el consumo de CPU:
...
Este repositorio implementa un flujo automatizado de integración continua mediante GitHub Actions localizado en .github/workflows/test.yml. Se ejecuta automáticamente ante cualquier evento de push en main o en ramas feature/*, así como en cada pull_request.
